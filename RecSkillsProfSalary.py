...
class ModelsRunner:
    ...
    def run_recomends(self,
        ...
        if self.modelType == "LDA":
            ...
            # 0.042*"react" + 0.040*"js" + 0.030*"git" + 0.029*"frontend"
            ...
            top_ids_words = self.model.model.components_[clust].argsort()[-(len(prepResume)+int(nRecSkills*1.5)):][::-1]
        ...
        target = self.model.resDF[self.model.resDF['Salary'] & ~self.model.resDF['Description'].isnull()][['From', 'To']].mean(axis=1)
